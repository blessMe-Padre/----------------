...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var wrapper = document.querySelector('.wrapper'); // const header = document.querySelector('.header');
  ...
  _modules_baguettebox_js__WEBPACK_IMPORTED_MODULE_1___default.a.run('.routs-item__img-wrapper'); // DOMContentLoaded
});
